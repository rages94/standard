...
class CreateCompletedStandardsFromText:
    def __init__(self, parse_standards: ParseStandards, create_completed_standards: CreateCompletedStandard) -> None:
        self.parse_standards = parse_standards
        self.create_completed_standards = create_completed_standards
    ...
    async def __call__(self, text: str, user_id: UUID, completed_type: CompletedType) -> dict[str, int]:
        ...
        for standard, count in parsed_params:
            ...
            await self.create_completed_standards(
